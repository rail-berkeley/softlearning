"""
Random cylinder position, sweeping over the scale rewards.
"""
import sys
import os
...
class VG(VariantGenerator):
    ...
    # Doesn't matter, this is overridden by gym_pusher.
    @variant
