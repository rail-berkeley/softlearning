...
exp_prefix = "humanoid/" + exp_id
exp_name_prefix = 'humanoid-' + exp_id
mode = "ec2"
# mode = "local_test"
...
class VG(VariantGenerator):
    ...
    def env_name(self):
        return [
            "softqlearning.envs.mujoco.humanoid.HumanoidEnv"
        ]
