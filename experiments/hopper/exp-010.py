...
exp_prefix = "hopper/" + exp_id
exp_name_prefix = 'hopper-' + exp_id
mode = "ec2"
# mode = "local_test"
...
class VG(VariantGenerator):
    ...
    def env_name(self):
        return [
            "softqlearning.envs.mujoco.hopper.HopperEnv"
        ]
    ...
    # Does this matter? Or is this overridden somewhere in GymHopper?
    @variant
...
for itr, v in enumerate(variants):
    ...
    batch_tasks.append(
        dict(
            ...
            env=dict(MUJOCO_PY_MJPRO_PATH='/root/code/rllab/vendor/mjpro131')
        )
    )
